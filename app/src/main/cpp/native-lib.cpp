...
extern "C"
JNIEXPORT void JNICALL Java_com_frank_solidcompose_Earth_initialization(JNIEnv *env, jobject obj,
                                                                        const jfloat e_x,
                                                                        const jfloat e_y,
                                                                        const jfloat e_z,
                                                                        const jfloat Z,
...
extern "C"
JNIEXPORT void JNICALL Java_com_frank_solidcompose_Earth_Initialization2(JNIEnv *env, jobject obj,
                                                                         const jint width0,
                                                                         const jint height0,
                                                                         const jint width1,
                                                                         const jint height1,
...
extern "C"
JNIEXPORT jint JNICALL Java_com_frank_solidcompose_Earth_transforms(JNIEnv *env, jobject obj,
...
extern "C"
JNIEXPORT void JNICALL Java_com_frank_solidcompose_Common_setEYE(JNIEnv *env, jobject obj,
                                                          const jfloat e_x,
                                                          const jfloat e_y,
                                                          const jfloat e_z) {
    eye_x = e_x;
...
extern "C"
JNIEXPORT jint JNICALL Java_com_frank_solidcompose_Common_isVisible(JNIEnv *env, jobject obj,
                                                             const jfloat xE,
                                                             const jfloat yE,
                                                             const jfloat zE,
                                                             const jfloat xF,
...
Java_com_frank_solidcompose_polyhedron_PictCube_Initialization2(JNIEnv *env, jobject obj,
...
extern "C"
JNIEXPORT void JNICALL Java_com_frank_solidcompose_polyhedron_PictCube_transforms(JNIEnv *env, jobject obj,
                                                                        const jint count,
                                                                        const jint index1,
                                                                        const jint index2,
                                                                        const jint index3,
